...
def write_distribution(reports_lib, num_of_buckets, file_quarter):
	with open("DRUG%s_rep_instances.csv" % file_quarter, 'w', newline='') as csvfile:
		spamwriter = csv.writer(csvfile, delimiter=',')
...
def write_frequency(reports_lib, num_of_buckets, file_quarter):
	with open("DRUG%s_rep_frequency.csv" % file_quarter, 'w', newline='') as csvfile:
		spamwriter = csv.writer(csvfile, delimiter=',')
		spamwriter.writerow(["Year", "Frequency: List"])
		for i in reports_lib:
			spamwriter.writerow([i, Counter(reports_lib[i])])
			print(i, Counter(reports_lib[i]))
...
for file_quarter in file_quarters:
	...
	write_frequency(reports_lib, num_of_buckets, file_quarter)
